...
local packType = UIX.Require:import(__FUSION_SRC_PATH__('/Animation/packType.lua'))
local springCoefficients = UIX.Require:import(__FUSION_SRC_PATH__('/Animation/springCoefficients.lua'))
