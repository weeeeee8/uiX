...
local lerpType = UIX.Require:import(__FUSION_SRC_PATH__('/Animation/lerpType.lua'))
local getTweenRatio = UIX.Require:import(__FUSION_SRC_PATH__('/Animation/getTweenRatio.lua'))
